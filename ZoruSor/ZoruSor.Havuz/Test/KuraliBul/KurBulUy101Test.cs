...
{
    [DisplayName("Kurali Bulup Uygula 10")]
    [HighlightedClass]
    public class KurBulUy101Test : BaseTest
    {
        ...
        [HighlightedMember]
        public KurBulUy101Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
            for (int i = 0; i < SayfadakiSoruAdet * sayfaAdet; i++)
            {
                var soruCreater = new SoruCreater();
                SoruBuilder builder = new KuraliBulUygula10
                {
                    Havuz = havuz,
        ...
        public KurBulUy101Test(IEnumerable<TestDetail> testDetails)
        {
