...
namespace ZoruSor.Lib.Test.KuraliBul
{
    ...
    [HighlightedClass]
    public class KurBulUy111Test : BaseTest
    {
        ...
        [HighlightedMember]
        public KurBulUy111Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
        ...
        public KurBulUy111Test(IEnumerable<TestDetail> testDetails)
        {
