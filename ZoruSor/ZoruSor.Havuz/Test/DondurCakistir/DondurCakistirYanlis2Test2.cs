...
namespace ZoruSor.Lib.Test.DondurCakistir
{
    ...
    [HighlightedClass]
    public class DondurCakistirYanlis2Test2 : BaseTest
    {
        ...
        [HighlightedMember]
        public DondurCakistirYanlis2Test2(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
        ...
        public DondurCakistirYanlis2Test2(IEnumerable<TestDetail> testDetails)
        {
