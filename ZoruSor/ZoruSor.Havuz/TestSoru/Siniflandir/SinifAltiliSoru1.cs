...
{
    public class SinifAltiliSoru1 : BaseSoru
    {
        public SinifAltiliSoru1(Soru.Soru soru)
        {
            Soru = soru;
            var idList = new List<int>();var id = RandomHelper.RandomNumber(0, 5);
            ReferansResim1 = soru.ReferansResimList[id].Image;
            idList.Add(id);
            id = RandomHelper.RandomDifferentNumber(0, 5, idList.ToArray());
