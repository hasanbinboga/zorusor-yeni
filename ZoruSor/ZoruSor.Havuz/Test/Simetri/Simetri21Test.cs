...
namespace ZoruSor.Lib.Test.Simetri
{
    ...
    [HighlightedClass]
    public class Simetri21Test : BaseTest
    {
        ...
        [HighlightedMember]
        public Simetri21Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
        ...
        public Simetri21Test(IEnumerable<TestDetail> testDetails)
        {
