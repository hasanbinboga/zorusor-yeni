...
namespace ZoruSor.Lib.Test.DondurCakistir
{
    ...
    [HighlightedClass]
    public class DondurCakistirDogru1Test2 : BaseTest
    {
        ...
        [HighlightedMember]
        public DondurCakistirDogru1Test2(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
        ...
        public DondurCakistirDogru1Test2(IEnumerable<TestDetail> testDetails)
        {
