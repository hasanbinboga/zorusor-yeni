...
{
    [DisplayName("Kurali Bulup Uygula 121")]
    [HighlightedClass]
    public class KurBulUy131Test : BaseTest
    {
        ...
        [HighlightedMember]
        public KurBulUy131Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
            for (int i = 0; i < SayfadakiSoruAdet * sayfaAdet; i++)
            {
                var soruCreater = new SoruCreater();
                SoruBuilder builder = new KuraliBulUygula13
                {
                    Havuz = havuz,
        ...
        public KurBulUy131Test(IEnumerable<TestDetail> testDetails)
        {
