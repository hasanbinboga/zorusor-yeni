...
namespace ZoruSor.Lib.Soru
{
    ...
    /// </summary>
    class AnalojiParca2 : SoruBuilder
    {
        ...
        public override void ReferansResimUret()
        {
            ...
            birlesik2 = ResimHelper.IkiResimBirlestir(_referansResim1, _referansResim2, ResimBoyut);
        ...
        public override void CeldiriciUret()
        {
            for (int i = 0; i < CeldiriciAdet; i++)
            {
                ...
                {
                    //Referans resimlerin parca resimlerini uret
                    var parca1 = ResimHelper.ParcaResimUret(Havuz, solResim.ParcaList, ResimBoyut / 4);
