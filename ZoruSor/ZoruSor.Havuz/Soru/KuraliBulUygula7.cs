...
{
    /// <summary>
    /// Bu soru şablonu 4. soru turunden daha zordur. Guclu ve zayif parcalarin siralari karisiktir.
    ...
    /// </summary>
    public class KuraliBulUygula7 : SoruBuilder
    {
        ...
        public override void ReferansResimUret()
        {
            ...
            var gucluListShuffled = gucluList.Shuffle();
            var zayifListShuffled = zayifList.Shuffle();
            var guclu1ListShuffled = guclu1List.Shuffle();
            var zayif1ListShuffled = zayif1List.Shuffle();

            Soru.ReferansResimList.Add(ResimHelper.IslemResimUret(Havuz, _satirList[0].Resim1, _satirList[0].Resim2, _satirList[0].Sonuc, _satirList[0].SonucBuyuk, gucluListShuffled, zayifListShuffled, ResimBoyut));
            Soru.ReferansResimList.Add(ResimHelper.IslemSoruResimUret(Havuz, _satirList[1].Resim1, _satirList[1].Resim2, _satirList[1].SonucBuyuk, guclu1ListShuffled, zayif1ListShuffled, ResimBoyut));
        }
