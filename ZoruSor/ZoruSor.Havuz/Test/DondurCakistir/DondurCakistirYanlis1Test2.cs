...
namespace ZoruSor.Lib.Test.DondurCakistir
{
    ...
    [HighlightedClass]
    public class DondurCakistirYanlis1Test2 : BaseTest
    {
        ...
        [HighlightedMember]
        public DondurCakistirYanlis1Test2(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
            for (int i = 0; i < SayfadakiSoruAdet * sayfaAdet; i++)
            {
                var soruCreater = new SoruCreater();
                SoruBuilder builder = new DondurCakistirYanlisBul1
                {
                    Havuz = havuz,
        ...
        public DondurCakistirYanlis1Test2(IEnumerable<TestDetail> testDetails)
        {
