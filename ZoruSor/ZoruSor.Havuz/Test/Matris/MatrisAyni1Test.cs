...
namespace ZoruSor.Lib.Test
{
    ...
    [HighlightedClass]
    public class MatrisAyni1Test : BaseTest
    {
        ...
        [HighlightedMember]
        public MatrisAyni1Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
            for (int i = 0; i < SayfadakiSoruAdet * sayfaAdet; i++)
            {
                var soruCreater = new SoruCreater();
                SoruBuilder builder = new MatrisAyni1()
                {
                    Havuz = havuz,
        ...
        public MatrisAyni1Test(IEnumerable<TestDetail> testDetails)
        {
