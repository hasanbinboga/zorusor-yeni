...
namespace ZoruSor.Lib.Test.KuraliBul
{
    ...
    [HighlightedClass]
    public class KurBulUy72Test : BaseTest
    {
        ...
        [HighlightedMember]
        public KurBulUy72Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
        ...
        public KurBulUy72Test(IEnumerable<TestDetail> testDetails)
        {
