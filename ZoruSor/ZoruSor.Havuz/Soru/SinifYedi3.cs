...
{
    public class SinifYedi3 : SoruBuilder
    {
        ...
        public override void ReferansResimUret()
        {
            ...
            //Kac ortak resim olacagini 3 ile 7 arasinda random olarak belirle
            _ortakResimAdet = RandomHelper.RandomNumber(3, 7);
            ...
            //Eger ortak resim adedi 7 ten kucukse
            if (_ortakResimAdet <= 7)
            {
                ...
                //Rasgele 7-ortak resim adet kadar  resim uret.
                for (int i = 0; i < 7 - _ortakResimAdet; i++)
                {
                ...
                for (int i = _ortakResimAdet; i < 7; i++)
                {
