...
{
    [DisplayName("Kurali Bulup Uygula 1")]
    [HighlightedClass]
    public class KurBulUy12Test : BaseTest
    {
        ...
        [HighlightedMember]
        public KurBulUy12Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
            for (int i = 0; i < SayfadakiSoruAdet * sayfaAdet; i++)
            {
                var soruCreater = new SoruCreater();
                SoruBuilder builder = new KuraliBulUygula1
                {
                    Havuz = havuz,
        ...
        public KurBulUy12Test(IEnumerable<TestDetail> testDetails)
        {
