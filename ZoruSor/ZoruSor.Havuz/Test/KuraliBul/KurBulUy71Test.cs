...
{
    [DisplayName("Kurali Bulup Uygula 7")]
    [HighlightedClass]
    public class KurBulUy71Test : BaseTest
    {
        ...
        [HighlightedMember]
        public KurBulUy71Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
            for (int i = 0; i < SayfadakiSoruAdet * sayfaAdet; i++)
            {
                var soruCreater = new SoruCreater();
                SoruBuilder builder = new KuraliBulUygula7
                {
                    Havuz = havuz,
        ...
        public KurBulUy71Test(IEnumerable<TestDetail> testDetails)
        {
