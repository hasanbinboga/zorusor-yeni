...
{
    [DisplayName("Simetrik Iliskiler 3")]
    [HighlightedClass]
    public class Simetri32Test : BaseTest
    {
        ...
        [HighlightedMember]
        public Simetri32Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
            for (int i = 0; i < SayfadakiSoruAdet * sayfaAdet; i++)
            {
                var soruCreater = new SoruCreater();
                SoruBuilder builder = new SimetrikIliski3()
                {
                    Havuz = havuz,
        ...
        public Simetri32Test(IEnumerable<TestDetail> testDetails)
        {
