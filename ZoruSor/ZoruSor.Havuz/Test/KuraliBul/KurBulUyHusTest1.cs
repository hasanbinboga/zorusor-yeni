...
namespace ZoruSor.Lib.Test.KuraliBul
{
    ...
    [HighlightedClass]
    public class KurBulUyHusTest1 : BaseTest
    {
        ...
        [HighlightedMember]
        public KurBulUyHusTest1(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
        ...
        public KurBulUyHusTest1(IEnumerable<TestDetail> testDetails)
        {
