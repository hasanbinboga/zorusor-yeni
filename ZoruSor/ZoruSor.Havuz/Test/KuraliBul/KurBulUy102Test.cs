...
namespace ZoruSor.Lib.Test.KuraliBul
{
    ...
    [HighlightedClass]
    public class KurBulUy102Test : BaseTest
    {
        ...
        [HighlightedMember]
        public KurBulUy102Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
        ...
        public KurBulUy102Test(IEnumerable<TestDetail> testDetails)
        {
