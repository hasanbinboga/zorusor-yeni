...
{
    /// <summary>
    /// Bu soru şablonu 8 ila 10. soru sablonlarina benzemektedir. Ancak parcalarin uc farkli degeri vardir.
    ...
    /// </summary>
    public class KuraliBulUygula11 : SoruBuilder
    {
        ...
        private List<ParcaDeger> SatirOlustur()
        {
            ...
            satir.GucluList = gucluList.Shuffle();
            satir.NormalList = normalList.Shuffle();
            satir.ZayifList = zayifList.Shuffle();
