...
{
    [DisplayName("Siniflandirma Altili 3")]
    [HighlightedClass]
    public class SinifAltili3Test : BaseTest
    {
        ...
        [HighlightedMember]
        public SinifAltili3Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
            for (int i = 0; i < SayfadakiSoruAdet * sayfaAdet; i++)
            {
                var soruCreater = new SoruCreater();
                SoruBuilder builder = new SinifAlti3
                {
                    Havuz = havuz,
        ...
        public SinifAltili3Test(IEnumerable<TestDetail> testDetails)
        {
