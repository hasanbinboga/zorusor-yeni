...
namespace ZoruSor.Lib.Soru
{
    ...
    /// </summary>
    public class SimetrikIliski5 : SoruBuilder
    {
        ...
        public override void ReferansResimUret()
        {
            ...
            Soru.ReferansResimList.Add(ResimHelper.IslemResimUret(Havuz, _satirList[siraList[0]].Resim1, _satirList[siraList[0]].Resim2, _satirList[siraList[0]].Sonuc, _satirList[siraList[0]].SonucBuyuk, ResimBoyut));
            Soru.ReferansResimList.Add(ResimHelper.IslemResimUret(Havuz, _satirList[siraList[1]].Resim1, _satirList[siraList[1]].Resim2, _satirList[siraList[1]].Sonuc, _satirList[siraList[1]].SonucBuyuk, ResimBoyut));
            Soru.ReferansResimList.Add(ResimHelper.IslemResimUret(Havuz, _satirList[siraList[2]].Resim1, _satirList[siraList[2]].Resim2, _satirList[siraList[2]].Sonuc, _satirList[siraList[2]].SonucBuyuk, ResimBoyut));
            Soru.ReferansResimList.Add(ResimHelper.IslemResimUret(Havuz, _satirList[siraList[3]].Resim1, _satirList[siraList[3]].Resim2, _satirList[siraList[3]].Sonuc, _satirList[siraList[3]].SonucBuyuk, ResimBoyut));


            Soru.ReferansResimList.Add(ResimHelper.IslemSoruResimUret(Havuz, _satirList[4].Resim1, _satirList[4].Resim2, _satirList[4].SonucBuyuk, ResimBoyut));
            Soru.ReferansResimList.Add(ResimHelper.IslemSoruResimUret(Havuz, _satirList[5].Resim1, _satirList[5].Resim2, _satirList[5].SonucBuyuk, ResimBoyut));
