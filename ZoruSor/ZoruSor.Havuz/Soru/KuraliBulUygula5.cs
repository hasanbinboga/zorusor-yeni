...
{
    /// <summary>
    /// Bu soru şablonu onceki kurali bulup uygulama soru turlerinden cok daha basittir. 4. soru turunden biraz daha zordur.
    ...
    /// </summary>
    public class KuraliBulUygula5 : SoruBuilder
    {
