...
{
    /// <summary>
    /// Bu soru şablonu 11. soru sablonuna benzemektedir. Ancak daha basittir. Parcalarin uc farkli degeri vardir.
    /// Her bir referans resimde rastgele guclu, normal ve zayif parcalardan olusur. Isleme giren parcalarin uc degeri vardir. 
    /// Bu parcalarin degerleri ise satirlarin ilk basinda gosterilir. Daha sonra onceki kurali bul uygula soru turlerinde oldugu gibi 
    ...
    /// </summary>
    public class KuraliBulUygula13 : SoruBuilder
    {
        ...
        private List<ParcaDeger> SatirOlustur(bool islem1, bool islem2, int parantezId)
        {
            ...
            var satir = SatirIslemOlustur(referansResim, parcaDegerList, resim1parcaDeger, islem1, resim2parcaDeger, islem2, resim3parcaDeger, parantezId);


            //satirlarin siralarini rastgele belirle

            var gucluList = new Dictionary<string, int>();
            var normalList = new Dictionary<string, int>();
            var zayifList = new Dictionary<string, int>();
            foreach (var parca in parcaDegerList)
            {
                gucluList.Add(parca.Ad, parca.IdDegerList[3]);
                normalList.Add(parca.Ad, parca.IdDegerList[2]);
                zayifList.Add(parca.Ad, parca.IdDegerList[1]);
            }

            satir.GucluList = gucluList;
            satir.NormalList = normalList;
        ...
        public override void ReferansResimUret()
        {
            ...
            var parantezId = RandomHelper.RandomNumber(0, 1);

            SatirOlustur(islem1, islem2, parantezId);
            _parcaDegerList = SatirOlustur(islem1, islem2, parantezId);
            ...
            var satir1args = new KuraliBulSatirArg
            {
                ...
                NormalList = _satirList[0].NormalList,
            ...
            var satir2args = new KuraliBulSatirArg
            {
                ...
                NormalList = _satirList[1].NormalList,
