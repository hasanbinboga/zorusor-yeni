...
{
    [DisplayName("Para Oyun Test 4 1 2")]
    [HighlightedClass]
    public class ParaOyun41Test2 : BaseTest
    {
        ...
        [HighlightedMember]
        public ParaOyun41Test2(int zorlukDerece, int sayfaAdet)
        {
        ...
        public ParaOyun41Test2(IEnumerable<TestDetail> testDetails)
        {
