...
{
    [DisplayName("Siniflandirma Altili 1")]
    [HighlightedClass]
    public class SinifAltili1Test : BaseTest
    {
        ...
        [HighlightedMember]
        public SinifAltili1Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
            for (int i = 0; i < SayfadakiSoruAdet * sayfaAdet; i++)
            {
                var soruCreater = new SoruCreater();
                SoruBuilder builder = new SinifAlti1(){
                    Havuz = havuz,
        ...
        public SinifAltili1Test(IEnumerable<TestDetail> testDetails)
        {
