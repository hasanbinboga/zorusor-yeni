...
namespace ZoruSor.Lib.Soru
{
    ...
    /// ikidir. Belirtilen havuzdaki parca sayisi ikiye bolunur ve ilk referans resime daha fazla
    /// parca konur. Ikinci referans resime kalan parcalar konur. Her pa
    /// rca icin +-20 ila +- 340 
    /// derece arasinda bir aci belirlenir. Hangi parcanin hangi yonde donduruldugu belirtilir.
    /// Ilk satirda cevap verilir. Cevap resminde Her iki referans resimdeki parcalar belirtilen
    /// aci kadar dondurulur ve birlestirilir.
    /// </summary>
    public class DondurBul1 : SoruBuilder
    {
