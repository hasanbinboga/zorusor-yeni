...
{
    [DisplayName("Kurali Bulup Uygula 6")]
    [HighlightedClass]
    public class KurBulUy61Test : BaseTest
    {
        ...
        [HighlightedMember]
        public KurBulUy61Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
            for (int i = 0; i < SayfadakiSoruAdet * sayfaAdet; i++)
            {
                var soruCreater = new SoruCreater();
                SoruBuilder builder = new KuraliBulUygula6
                {
                    Havuz = havuz,
        ...
        public KurBulUy61Test(IEnumerable<TestDetail> testDetails)
        {
