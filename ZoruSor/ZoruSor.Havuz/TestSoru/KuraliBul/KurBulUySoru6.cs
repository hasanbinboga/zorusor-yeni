...
{
    public class KurBulUySoru6 : BaseSoru
    {
        public KurBulUySoru6(Soru.Soru soru)
        {
            Soru = soru;
            //Soruda sadece soru satiri oldugundan ilk islem satiri yerine ikinci islem satiri gelir.
            ReferansResim1 = soru.ReferansResimList[1].Image;
