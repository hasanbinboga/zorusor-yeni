...
namespace ZoruSor.Lib.Test.DondurCakistir
{
    ...
    [HighlightedClass]
    public class DondurCakistirDogru2Test3 : BaseTest
    {
        ...
        [HighlightedMember]
        public DondurCakistirDogru2Test3(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
        ...
        public DondurCakistirDogru2Test3(IEnumerable<TestDetail> testDetails)
        {
