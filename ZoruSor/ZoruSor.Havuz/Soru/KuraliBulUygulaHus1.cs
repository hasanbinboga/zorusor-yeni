...
namespace ZoruSor.Lib.Soru
{
    ...
    /// </summary>
    public class KuraliBulUygulaHus1 : SoruBuilder
    {
        ...
        public override void CeldiriciUret()
        {
            ...
            var sonSatir1 = ResimHelper.MelezResimUret(ResimHelper.ResimUret(Havuz, _satirList[1].Resim1, ResimBoyut), "", ResimBoyut, 4);
            var sonSatir2 = ResimHelper.MelezResimUret(ResimHelper.ResimUret(Havuz, _satirList[1].Resim2, ResimBoyut), "", ResimBoyut, 4);
            ...
            for (var i = 0; i < kalanCeldirici; i++)
            {
                ...
                else
                {
                    ...
                    Soru.CeldiriciList.Add(ResimHelper.MelezResimUret(sonuc, "", ResimBoyut, 4));
                }
            }
