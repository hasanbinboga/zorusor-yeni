...
namespace ZoruSor.Lib.Test.KuraliBul
{
    ...
    [HighlightedClass]
    public class KurBulUy92Test : BaseTest
    {
        ...
        [HighlightedMember]
        public KurBulUy92Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
        ...
        public KurBulUy92Test(IEnumerable<TestDetail> testDetails)
        {
