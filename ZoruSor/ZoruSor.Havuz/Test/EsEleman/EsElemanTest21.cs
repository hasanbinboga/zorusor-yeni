...
namespace ZoruSor.Lib.Test.EsEleman
{
    ...
    [HighlightedClass]
    public class EsElemanTest21 : BaseTest
    {
        ...
        [HighlightedMember]
        public EsElemanTest21(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
            for (int i = 0; i < SayfadakiSoruAdet * sayfaAdet; i++)
            {
                var soruCreater = new SoruCreater();
                SoruBuilder builder = new EsEleman2
                {
                    Havuz = havuz,
        ...
        public EsElemanTest21(IEnumerable<TestDetail> testDetails)
        {
