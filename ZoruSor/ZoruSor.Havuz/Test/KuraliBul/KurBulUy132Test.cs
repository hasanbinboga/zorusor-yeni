...
{
    [DisplayName("Kurali Bulup Uygula 13")]
    [HighlightedClass]
    public class KurBulUy132Test : BaseTest
    {
        ...
        [HighlightedMember]
        public KurBulUy132Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
        ...
        public KurBulUy132Test(IEnumerable<TestDetail> testDetails)
        {
