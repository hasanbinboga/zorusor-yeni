...
namespace ZoruSor.Lib.Test.DondurCakistir
{
    ...
    [HighlightedClass]
    public class DondurCakistirYanlis1Test1 : BaseTest
    {
        ...
        [HighlightedMember]
        public DondurCakistirYanlis1Test1(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
        ...
        public DondurCakistirYanlis1Test1(IEnumerable<TestDetail> testDetails)
        {
