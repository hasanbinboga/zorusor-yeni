...
namespace ZoruSor.Lib.Test.DondurCakistir
{
    ...
    [HighlightedClass]
    public class DondurCakistirDogru2Test1 : BaseTest
    {
        ...
        [HighlightedMember]
        public DondurCakistirDogru2Test1(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
        ...
        public DondurCakistirDogru2Test1(IEnumerable<TestDetail> testDetails)
        {
