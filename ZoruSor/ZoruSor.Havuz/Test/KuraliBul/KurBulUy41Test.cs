...
{
    [DisplayName("Kurali Bulup Uygula 4")]
    [HighlightedClass]
    public class KurBulUy41Test : BaseTest
    {
        ...
        [HighlightedMember]
        public KurBulUy41Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
            for (int i = 0; i < SayfadakiSoruAdet * sayfaAdet; i++)
            {
                var soruCreater = new SoruCreater();
                SoruBuilder builder = new KuraliBulUygula4
                {
                    Havuz = havuz,
        ...
        public KurBulUy41Test(IEnumerable<TestDetail> testDetails)
        {
