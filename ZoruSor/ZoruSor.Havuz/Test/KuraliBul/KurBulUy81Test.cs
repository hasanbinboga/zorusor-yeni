...
{
    [DisplayName("Kurali Bulup Uygula 8")]
    [HighlightedClass]
    public class KurBulUy81Test : BaseTest
    {
        ...
        [HighlightedMember]
        public KurBulUy81Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
            for (int i = 0; i < SayfadakiSoruAdet * sayfaAdet; i++)
            {
                var soruCreater = new SoruCreater();
                SoruBuilder builder = new KuraliBulUygula8
                {
                    Havuz = havuz,
        ...
        public KurBulUy81Test(IEnumerable<TestDetail> testDetails)
        {
