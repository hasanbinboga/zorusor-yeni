...
{
    /// <summary>
    /// Bu soru şablonu simetrik ilişki 1 e göre daha basittir. Her parçanın 4 değeri vardır. Ancak ilk iki satırda 1. değer
    /// ile ikinci değeri karşılaştırır. Diğer iki satırda ise 3. ve 4. değeri karşılaştırır.
    /// </summary>
    public class SimetrikIliski2 : SoruBuilder
    {
        ...
        public override void ReferansResimUret()
        {
            ...
            Soru.ReferansResimList.Add(ResimHelper.IslemSoruResimUret(Havuz, _satirList[3].Resim1, _satirList[3].Resim2, false, ResimBoyut));
        }
