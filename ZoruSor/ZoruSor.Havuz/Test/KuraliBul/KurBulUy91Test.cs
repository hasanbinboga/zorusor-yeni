...
{
    [DisplayName("Kurali Bulup Uygula 9")]
    [HighlightedClass]
    public class KurBulUy91Test : BaseTest
    {
        ...
        [HighlightedMember]
        public KurBulUy91Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
            for (int i = 0; i < SayfadakiSoruAdet * sayfaAdet; i++)
            {
                var soruCreater = new SoruCreater();
                SoruBuilder builder = new KuraliBulUygula9
                {
                    Havuz = havuz,
        ...
        public KurBulUy91Test(IEnumerable<TestDetail> testDetails)
        {
