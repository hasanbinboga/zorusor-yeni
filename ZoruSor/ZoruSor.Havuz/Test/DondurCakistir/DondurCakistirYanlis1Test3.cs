...
namespace ZoruSor.Lib.Test.DondurCakistir
{
    ...
    [HighlightedClass]
    public class DondurCakistirYanlis1Test3 : BaseTest
    {
        ...
        [HighlightedMember]
        public DondurCakistirYanlis1Test3(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
        ...
        public DondurCakistirYanlis1Test3(IEnumerable<TestDetail> testDetails)
        {
