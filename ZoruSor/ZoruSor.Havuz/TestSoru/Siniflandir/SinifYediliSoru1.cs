...
{
    public class SinifYediliSoru1 : BaseSoru
    {
        public SinifYediliSoru1(Soru.Soru soru)
        {
            Soru = soru;
            var idList = new List<int>();
            var id = RandomHelper.RandomNumber(0, 6);
            ReferansResim1 = soru.ReferansResimList[id].Image;
            idList.Add(id);
            id = RandomHelper.RandomDifferentNumber(0, 6, idList.ToArray());
            ...
            id = RandomHelper.RandomDifferentNumber(0, 6, idList.ToArray());
            ReferansResim6 = soru.ReferansResimList[id].Image;
            id = RandomHelper.RandomDifferentNumber(0, 6, idList.ToArray());
            ReferansResim7 = soru.ReferansResimList[id].Image;
