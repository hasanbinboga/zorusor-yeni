...
{
    public class EsEleman4 : SoruBuilder
    {
        ...
        public override void CeldiriciUret()
        {
            ...
            for (var i = 0; i < CeldiriciAdet; i++)
            {
                ...
                if (RandomHelper.RandomBool())
                {
                Soru.CeldiriciList.Add(ResimHelper.IkiResimBirlestir(parcalanmis, _referansResim, ResimBoyut));

                }
                else
                {
                Soru.CeldiriciList.Add(ResimHelper.IkiResimBirlestir(_referansResim, parcalanmis, ResimBoyut));
