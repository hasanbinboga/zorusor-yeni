...
namespace ZoruSor.Lib.Test.KuraliBul
{
    ...
    [HighlightedClass]
    public class KurBulUy21Test : BaseTest
    {
        ...
        [HighlightedMember]
        public KurBulUy21Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
        ...
        public KurBulUy21Test(IEnumerable<TestDetail> testDetails)
        {
