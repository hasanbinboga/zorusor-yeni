...
{
    [DisplayName("Kurali Bulup Uygula 2")]
    [HighlightedClass]
    public class KurBulUy22Test : BaseTest
    {
        ...
        [HighlightedMember]
        public KurBulUy22Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
            for (int i = 0; i < SayfadakiSoruAdet * sayfaAdet; i++)
            {
                var soruCreater = new SoruCreater();
                SoruBuilder builder = new KuraliBulUygula2
                {
                    Havuz = havuz,
        ...
        public KurBulUy22Test(IEnumerable<TestDetail> testDetails)
        {
