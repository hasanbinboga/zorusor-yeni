...
namespace ZoruSor.Lib.Test.Simetri
{
    ...
    [HighlightedClass]
    public class Simetri11Test : BaseTest
    {
        private const int SayfadakiSoruAdet = 2;
        private const int CeldiriciAdet = 8;
        private const int ResimBoyut = 135;
        [HighlightedMember]
        public Simetri11Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
        ...
        public Simetri11Test(IEnumerable<TestDetail> testDetails)
        {
