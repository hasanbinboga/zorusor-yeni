...
{
    public class OruntuProcessor : ProcessorTemplate
    {
        ...
        public void ShapeOnDrop(object sender, DragEventArgs e)
        {
            ...
            var ib = new ImageBrush { ImageSource = new BitmapImage(new Uri(image.Path, UriKind.RelativeOrAbsolute)), Stretch = Stretch.Fill };
        ...
        private ContextMenu CreateMenu(Shape shape)
        {
            ...
            itemResimKaydet.Click += (sender, e) =>
            {
            ...
            itemDuzenle.Click += (o, args) =>
            {
                ...
                {
                    MessageBox.Show("Havuz kopyalanırken hata oluştu:" + ex, "Bilişsel Beceriler", MessageBoxButton.OK);
