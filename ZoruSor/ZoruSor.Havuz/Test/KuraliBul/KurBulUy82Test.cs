...
namespace ZoruSor.Lib.Test.KuraliBul
{
    ...
    [HighlightedClass]
    public class KurBulUy82Test : BaseTest
    {
        ...
        [HighlightedMember]
        public KurBulUy82Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
        ...
        public KurBulUy82Test(IEnumerable<TestDetail> testDetails)
        {
