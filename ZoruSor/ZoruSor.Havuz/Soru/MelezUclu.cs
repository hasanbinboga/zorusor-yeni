...
{
    public class MelezUclu : SoruBuilder
    {
        ...
        public override void ReferansResimUret()
        {
            ...
            //Havuzdaki parca sayisinin 3 te 1 i zorluk derecesinden dusukse
            if (ZorlukDerece < Havuz.ParcaList.Count / 3)
            {
                switch (ZorlukDerece)
                {
                    case 1:
            ...
            else
            {
                ...
                a = RandomHelper.RandomNumber(1, toplamParca - 2);

                //resim2 icin kalan parcalardan rasgele parca sayisi sec
                b = RandomHelper.RandomNumber(1, toplamParca - (a + 1));
            ...
            var maxLen = new List<int> { frm1.Length, frm2.Length, frm3.Length }.Max();
