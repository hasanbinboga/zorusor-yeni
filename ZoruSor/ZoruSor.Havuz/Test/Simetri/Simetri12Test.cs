...
{
    [DisplayName("Simetrik Iliskiler 1")]
    [HighlightedClass]
    public class Simetri12Test : BaseTest
    {
        ...
        [HighlightedMember]
        public Simetri12Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
            for (int i = 0; i < SayfadakiSoruAdet * sayfaAdet; i++)
            {
                var soruCreater = new SoruCreater();
                SoruBuilder builder = new SimetrikIliski1()
                {
                    Havuz = havuz,
        ...
        public Simetri12Test(IEnumerable<TestDetail> testDetails)
        {
