...
namespace ZoruSor.Lib.Test.Cakistirma
{
    ...
    [HighlightedClass]
    public class CakistirmaDogru1Test : BaseTest
    {
        ...
        [HighlightedMember]
        public CakistirmaDogru1Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
        ...
        public CakistirmaDogru1Test(IEnumerable<TestDetail> testDetails)
        {
