...
namespace ZoruSor.Lib.Test.Simetri
{
    ...
    [HighlightedClass]
    public class Simetri31Test : BaseTest
    {
        ...
        [HighlightedMember]
        public Simetri31Test(Havuz.Havuz havuz, int zorlukDerece, int sabitParcaAdet, int sayfaAdet)
        {
        ...
        public Simetri31Test(IEnumerable<TestDetail> testDetails)
        {
